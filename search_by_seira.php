...
?>
<h2>Αναζήτηση απουσιών μαθητών ΣΠΗΥ ανά εκπαιδευτική σειρά</h2>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    FROM apousies NATURAL JOIN students NATURAL JOIN vathmoi NATURAL JOIN specialization NATURAL JOIN seires NATURAL JOIN aitia NATURAL JOIN roles WHERE apousia = 1 AND stud_deleted = 0 AND deleted = 0 AND id_seires = ? ORDER BY imerominia, xronosfragida, students_surname, students_name, seires_name";
