...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    $query = "SELECT id_students, vathmoi_abbr, spec_abbr, students_surname, students_name, seires_name FROM (vathmoi NATURAL JOIN students NATURAL JOIN specialization) NATURAL JOIN seires WHERE stud_deleted = 0 ORDER BY seires_name";
    ...
    print "<h2>Μαθητές ΣΠΗΥ</h2>\n<p>Προβάλλετε τους μαθητές της ΣΠΗΥ</p>\n";
    $i = 0;
?>
    ...
    <table class="table table-bordered">
        ...
        <tbody id="myTable">
            ...
            while (my_mysqli_stmt_fetch($stmt)) {
                $i++;
                print "<tr>\n<td>$i</td>\n<td>$vathmos $spec</td>\n<td>$surname $name</td>\n<td>$seira</td>\n<td><a href='edit_student.php?id=$studID'>Τροποποίηση</a>/<a href='delete_student.php?id=$studID'>Αφαίρεση Μαθητή</a></td>\n</tr>\n";
            }
            ?>
        </tbody>
    </table>
